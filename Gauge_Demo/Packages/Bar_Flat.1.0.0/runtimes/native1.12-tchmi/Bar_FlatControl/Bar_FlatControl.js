...
(function (TcHmi) {
    ...
    (function (Controls) {
        let Bar_Flat;
        (function (Bar_Flat) {
            class Bar_FlatControl extends TcHmi.Controls.System.TcHmiControl {
                ...
                __previnit() {
                    ...
                    this.__uGauge = this.__element.find('.cydeus-bar-gauge');
                    this.__uGaugeBody = this.__element.find('.cydeus-bar-gauge-body');
                    this.__uGaugeFill = this.__element.find('.cydeus-bar-gauge-fill');
                    this.__uGaugeCover = this.__element.find('.cydeus-bar-gauge-cover');
                    this.__uGaugeTitle = this.__element.find('.cydeus-bar-gauge-title');
                    this.__uGaugePercent = this.__element.find('.cydeus-bar-gauge-percent');
                ...
                */
                ...
                __processData() {
                    ...
                    this.__uGaugePercent.text(value + '%');
                }
                ;
            ...
            Bar_Flat.Bar_FlatControl = Bar_FlatControl;
        })(Bar_Flat = Controls.Bar_Flat || (Controls.Bar_Flat = {}));
        Controls.registerEx('Bar_FlatControl', 'TcHmi.Controls.Bar_Flat', Bar_Flat.Bar_FlatControl);
    })(Controls = TcHmi.Controls || (TcHmi.Controls = {}));
})(TcHmi || (TcHmi = {}));
//# sourceMappingURL=Bar_FlatControl.js.map