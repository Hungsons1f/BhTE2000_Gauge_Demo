/*
 * Generated 8/24/2020 2:38:49 PM
 * Copyright (C) 2020
 */
var TcHmi;
(function (TcHmi) {
    let Controls;
    (function (Controls) {
        let Gauge_Flat_SemiCircle;
        (function (Gauge_Flat_SemiCircle) {
            class Gauge_Flat_SemiCircleControl extends TcHmi.Controls.System.TcHmiControl {
                ...
                __previnit() {
                    ...
                    this.__elementTemplateRoot = this.__element.find('.TcHmi_Controls_Gauge_Flat_SemiCircle_Gauge_Flat_SemiCircleControl-Template');
                    if (this.__elementTemplateRoot.length === 0) {
                        throw new Error('Invalid Template.html');
                    }
                    this.__uGauge = this.__element.find('.cydeus-gauge');
                    this.__uGaugeBody = this.__element.find('.cydeus-gauge-body');
                    this.__uGaugeFill = this.__element.find('.cydeus-gauge-fill');
                    this.__uGaugeCover = this.__element.find('.cydeus-gauge-cover');
                    this.__uGaugeTitle = this.__element.find('.cydeus-gauge-title');
                ...
                __processData() {
                    ...
                    if ((value < 0) || (value > 100)) {
                        ...
                        this.__uGaugeFill.css({
                            background: this.__uColorNormal //'#00ffff'
                        });
                    }
                    else if ((value >= this.__uWarningValue) && (value < this.__uAlarmValue)) {
                        this.__uGaugeFill.css({
                            background: this.__uColorWarning //'#f1f218'
                        });
                    }
                    else {
                        this.__uGaugeFill.css({
                            background: this.__uColorAlarm //'#ff4646'
                        });
                    }
                    this.__uGaugeFill.css({
                        transform: 'rotate(' + value * 0.005 + 'turn)'
                    });
            ...
            Gauge_Flat_SemiCircle.Gauge_Flat_SemiCircleControl = Gauge_Flat_SemiCircleControl;
        })(Gauge_Flat_SemiCircle = Controls.Gauge_Flat_SemiCircle || (Controls.Gauge_Flat_SemiCircle = {}));
        Controls.registerEx('Gauge_Flat_SemiCircleControl', 'TcHmi.Controls.Gauge_Flat_SemiCircle', Gauge_Flat_SemiCircle.Gauge_Flat_SemiCircleControl);
    })(Controls = TcHmi.Controls || (TcHmi.Controls = {}));
})(TcHmi || (TcHmi = {}));
//# sourceMappingURL=Gauge_Flat_SemiCircleControl.js.map